<h2>Parcel Hari Raya</h2>
<form method="post" action="<?= $_SERVER["PHP_SELF"]; ?>">

    Budget yang diinginkan (dalam rupiah) <input type='text' name="inputBudget" autofocus>
    &nbsp;
    <hr>
   <strong>products yang dipilih</strong>
    <br>
    <table><tr>
    <?php 
        require 'main.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($result)) {
        echo 'Tidak ada solusi ditemukan, silahkan coba lagi!.';
    } else {
        echo "<table>";
